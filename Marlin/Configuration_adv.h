...
#define LIN_ADVANCE   // MoWi
    ...
    #define ADVANCE_K { 1.46 } //MoWi   // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 1.46   // MoWi // (mm) Compression length applying to all extruders
  #endif
